...
export class DropdownDemoComponent {
  ...
  <tw-dropdown [open]="open" (click)="toggleDropdown()" className="shadow-lg divide-y divide-black/5 dark:divide-white/5">
  ...
  <tw-dropdown [open]="open" (click)="toggleDropdown()" className="shadow-lg *:justify-start *:rounded-none *:shadow-none">
    <ng-container *ngFor="let item of ['Account settings', 'Support', 'License', 'Sign out']">
      <tw-button className="hover:bg-black hover:bg-opacity-5 dark:hover:bg-white dark:hover:bg-opacity-5" variant="text">
        {{ item }}
      </tw-button>
    </ng-container>
  </tw-dropdown>
  ...
  roundedSimple = `<div>
  <tw-button variant="secondary" className="rounded-3xl" (click)="toggleDropdown()">
    Options
    <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path>
    </svg>
  ...
  <tw-dropdown [open]="open" (click)="toggleDropdown()" className="rounded-3xl shadow-lg divide-y divide-black/5 dark:divide-white/5 *:justify-start *:rounded-none *:shadow-none">
  ...
  <tw-dropdown [open]="open" (click)="toggleDropdown()" className="rounded-3xl shadow-lg *:justify-start divide-y divide-black/5 dark:divide-white/5 *:rounded-none *:shadow-none">
