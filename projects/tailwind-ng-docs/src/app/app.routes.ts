...
export const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				...
				loadComponent: () => import('./docs/customizations/customizations.component').then((m) => m.CustomizationsComponent),
			},
			{
...
export class AppTitleStrategy extends TitleStrategy {
	...
	override updateTitle(routerState: RouterStateSnapshot): void {
		...
		this.title.setTitle('Tailwind NG - Beautiful, fast and accessible UI components crafted with Tailwind CSS and Angular.');
	}
}
