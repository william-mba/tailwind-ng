				...
				children: [
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/avatars/customization/customization.component'
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/badges/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/buttons/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/button-groups/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/checkboxes/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/comboboxes/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/dialogs/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								title: 'Dropdowns API',
								loadComponent: () =>
									import('./docs/components/dropdowns/api/api.component').then(
										(m) => m.ApiComponent,
									),
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/dropdowns/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/icons/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/input-groups/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/radio-groups/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadComponent: () =>
									import(
										'./docs/components/toggles/customization/customization.component'
									).then((m) => m.CustomizationComponent),
							},
							{
								path: '',
