	...
	template: `
			...
			<div tw-dialog-container>
				...
				<div class="grid gap-3 text-center sm:text-left sm:flex sm:flex-row sm:items-start">
					...
					<div class="text-pretty text-sm text-gray-600 dark:text-gray-400">
						<h1 class="font-bold text-lg mb-3 text-gray-700 dark:text-gray-300">Deactivate account</h1>
				...
				<div class="flex justify-items-end flex-col gap-4 sm:flex-row-reverse">
					<button
						tw-button
						(click)="deactivateAccount.toggle()"
		...
		<div tw-dialog #deactivateAccount [restoreFocus]="true" class="open:backdrop-blur-none">
			...
			<div tw-dialog-container>
				...
				<div class="grid gap-3 text-center sm:text-left">
					<h1 class="font-bold text-balance text-lg my-0 text-gray-700 dark:text-gray-300">Confirmation</h1>
					<p class="text-sm text-gray-600 dark:text-gray-400">Are you sure you want to deactivate your account?</p>
				</div>
				<!-- Dialog actions -->
				<div class="flex justify-items-end flex-col gap-4 sm:flex-row-reverse">
					<button
						tw-button
						(click)="confirmation.toggle()"
						class="w-full sm:w-fit bg-red-600 hover:bg-red-600/90 active:bg-red-700/90 focus:outline-red-600/90"
					>
						YES
					</button>
		...
		<div tw-dialog #confirmation [restoreFocus]="true" class="open:backdrop-blur-none">
			...
			<div tw-dialog-container>
				<!-- Dialog content -->
				<div class="grid gap-3 text-center sm:text-left">
					<h1 class="font-bold text-balance text-lg my-0 text-gray-700 dark:text-gray-300">Really sure?</h1>
					<p class="text-sm text-gray-600 dark:text-gray-400">This action cannot be undone.</p>
				</div>
				<!-- Dialog actions -->
				<div class="flex justify-items-end gap-4 flex-row-reverse">
					<button tw-button (click)="confirmation.close()" class="w-full sm:w-fit bg-red-600 hover:bg-red-600/90 active:bg-red-700/90 focus:outline-red-600/90">
						YES
					</button>
