...
const DefaultConfig = () => {
  const className = 'appearance-none border-1 border-gray-300 dark:border-gray-700/70 checked:before:absolute checked:before:bg-white checked:before:inset-1 checked:before:rounded-full checked:bg-blue-600 checked:border-blue-600 disabled:bg-black/5 disabled:dark:bg-white/5 focus:outline-2 focus:outline-blue-600 focus:outline-offset-2 forced-colors:appearance-auto forced-colors:before:hidden relative rounded-full size-4';
  return className;
};
