...
import { classlist, Dropdown, DropdownBase, DropdownOptions, isEscape, OverlayPosition, TwIf } from '@tailwind-ng/core';
...
export class DropdownComponent extends DropdownBase implements Dropdown {
  ...
  @Input() override options?: DropdownOptions;
  ...
  protected override addEventListeners(): void {
    ...
    const { closeOnBlur = false } = this.options || {};
    if (closeOnBlur) {
