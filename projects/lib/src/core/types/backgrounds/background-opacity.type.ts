export type BackgroundOpacity =
  ...
  | 'dark:focus:bg-opacity-0'
  | 'dark:focus:bg-opacity-5'
  | 'dark:focus:bg-opacity-10'
  | 'dark:focus:bg-opacity-15'
  | 'dark:focus:bg-opacity-20'
  | 'dark:focus:bg-opacity-25'
  | 'dark:focus:bg-opacity-30'
  | 'dark:focus:bg-opacity-35'
  | 'dark:focus:bg-opacity-40'
  | 'dark:focus:bg-opacity-45'
  | 'dark:focus:bg-opacity-50'
  | 'dark:focus:bg-opacity-55'
  | 'dark:focus:bg-opacity-60'
  | 'dark:focus:bg-opacity-65'
  | 'dark:focus:bg-opacity-70'
  | 'dark:focus:bg-opacity-75'
  | 'dark:focus:bg-opacity-80'
  | 'dark:focus:bg-opacity-85'
  | 'dark:focus:bg-opacity-90'
  | 'dark:focus:bg-opacity-95'
  | 'dark:focus:bg-opacity-100'
  | 'disabled:bg-opacity-0'
  | 'disabled:bg-opacity-5'
  | 'disabled:bg-opacity-10'
  | 'disabled:bg-opacity-15'
  | 'disabled:bg-opacity-20'
  | 'disabled:bg-opacity-25'
  | 'disabled:bg-opacity-30'
  | 'disabled:bg-opacity-35'
